...
void add_obs_vel(double hub_value,struct light_rays_path *ray,int ifRel,int ifadd) {
	...
	if (ifRel == 1){
		if (ifadd == 1){
			ray[0].end[0] -= ray[0].normvec[0]*vr_obs/hub_value + MaxLineOfSight/SPEEDLIGHT*ray[0].normvec[0]*vr_obs - MaxLineOfSight/SPEEDLIGHT*run.ObsVel[0] ;
			ray[0].end[1] -= ray[0].normvec[1]*vr_obs/hub_value + MaxLineOfSight/SPEEDLIGHT*ray[0].normvec[1]*vr_obs - MaxLineOfSight/SPEEDLIGHT*run.ObsVel[1] ;
			ray[0].end[2] -= ray[0].normvec[2]*vr_obs/hub_value + MaxLineOfSight/SPEEDLIGHT*ray[0].normvec[2]*vr_obs - MaxLineOfSight/SPEEDLIGHT*run.ObsVel[2] ;
		...
		if (ifadd == 1){
			ray[0].end[0] -= ray[0].normvec[0]*vr_obs/hub_value ;
			ray[0].end[1] -= ray[0].normvec[1]*vr_obs/hub_value;
			ray[0].end[2] -= ray[0].normvec[2]*vr_obs/hub_value;
			ray[0].TimeDistance -= - vr_obs/(hub_value);
			ray[0].dlna +=  - vr_obs/SPEEDLIGHT;
		}
		else{
